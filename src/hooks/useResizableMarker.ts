...
const useResizeMarker = (el: React.MutableRefObject<HTMLDivElement | null>, saveDimensions: (w: number, h: number) => void, startWidth: number, startHeight: number, boundaryX: number, boundaryY: number) => {
